...
function Viswax() {
    ...
    this.getCurrent = function() {
        return new Promise(function (resolve, reject) {
            request.rsforum('http://services.runescape.com/m=forum/forums.ws?75,76,331,66006366').then(function(posts) {
                var sugar = posts.posts.filter(function(post) { post.username = post.username.replace('�', ' '); return post.username == 'Tiamat Rider';});
                ...
                console.log(editIndex, slot1Index, slot2Index, slot3Index);
                if (slot3Index <= 1) {
