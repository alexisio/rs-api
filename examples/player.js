...
/**
 * Get a players RuneScape 3 events log
 */
api.rs.player.events('sync').then(logEvents).catch(console.error);

/**
 * Get a players RuneScape 3 stats
 */
//api.rs.player.hiscores('zezima').then(logInfo).catch(console.error);
